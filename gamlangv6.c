/*
    gamlang compiler v6 by falkman
    Last revision: November 05, 2009
    ...
    Changes in this version:
        Bug fixes
        Added jumps
        Changed variable system a bit
            - Variable bug fixes
            - Universalized variable parsing
...
int storestr(char *code, func_t *func)
{
    ...
    *--ptr  = 0;
    ...
    addvar(identifier, string, stringlen, 's', func);
