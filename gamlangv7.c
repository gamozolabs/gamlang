/*
    ...
    Changes in this version:
        Added integers
        Added puthex
        Added addition of integers
        Added two types of conditional statments, ifequ (if equal), ifnequ (if not equal)
        Bug fixes
...
int ifnequ(char *code, func_t *func){
    ...
    char  *cmp, *jmp, *ptr,
          ifequ_data[] = {
            0x81, 0x3E, 0x00, 0x00, 0x00, 0x00, // cmp word [ptr], [var]
            0x0F, 0x85, 0x00, 0x00              // jz close [jmp]
        };
